...
import { Sponsor, SponsorsListRequest, SponsorsListItem } from './sponsors.types';
import { docsMapper } from '../../firebase';

@Injectable()
export class SponsorsDatasource extends ReactiveDataSource<SponsorsListRequest, SponsorsListItem[], Sponsor> {
  currentPage: number;
